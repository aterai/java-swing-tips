...
class WindowsCustomScrollBarUI extends WindowsScrollBarUI {
  @Override protected void layoutVScrollbar(JScrollBar sb) {
    ...
    Rectangle r = SwingUtilities.calculateInnerArea(sb, null);
    // r.x = sbInsets.left;
    // r.y = sbInsets.top;
    // r.width = sbSize.getWidth() - sbInsets.left - sbInsets.right;
    // r.height = sbSize.getHeight() - sbInsets.top - sbInsets.bottom;
    ...
    int incrButtonY = r.y + r.height - incrButtonH;
    ...
    int decrButtonY = r.y + r.height - incrButtonH - decrButtonH;
    decrButton.setBounds(r.x, decrButtonY, r.width, decrButtonH);
    incrButton.setBounds(r.x, incrButtonY, r.width, incrButtonH);
    ...
    trackRect.setBounds(r.x, 0, r.width, decrButtonY);
    ...
    int trackH = r.height - sbButtonsH - gaps;
